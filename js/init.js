...
var hidden_content_dict = {
  ...
  "tuning_hidden_content1": "We make sure to repeat this process both during the day and night in order to capture sets of images with non-bright and bright conditions, as well as tuned images under bright conditions. The main goal is to tune with different configuration settings to alleviate the amount of light sensitivity posed on the camera and make images as similar as possible to the regular, default settings. Configuration settings are saved as .yaml files within our workspace. We can modify our launch file to load the specific .yaml file that we want, whenever we run the car",
